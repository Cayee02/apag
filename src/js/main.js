...
import '../css/main.css';
import { createIcons, ArrowUpRight, ArrowRight, ArrowDown, Menu, X, Sprout, MapPin, UsersRound, Images, Phone, Mail } from 'lucide';
...
createIcons({ icons: { ArrowUpRight, ArrowRight, ArrowDown, Menu, X, Sprout, MapPin, UsersRound, Images, Phone, Mail }, attrs: { 'aria-hidden': 'true', 'stroke-width': 1.7 } });
const scroll = initSmoothScroll();
const cleanups = [initHeader(), initMobileMenu(scroll)];
cleanups.push(initPreloader(() => {
  cleanups.push(initHero(), initRevealAnimations());
}));
